...
const NewCategoryForm = () => {
  ...
  const onFinish = async (values) => {
    ...
    const newValues = {
      ...
      properties: {
        vehicle_details: getPropertiesObject(values.vehicle_details),
        body_details: getPropertiesObject(values.body_details),
        engine_details: getPropertiesObject(values.engine_details),
        extras: getPropertiesObject(values.extras),
      },
    };
            ...
            <Card title="Properties" className="card-layout">
              <Collapse>
                <Collapse.Panel header="Vehicle details" key="1">
                  <PropertiesFormList name="vehicle_details" />
                </Collapse.Panel>
                <Collapse.Panel header="Body details" key="2">
                  <PropertiesFormList name="body_details" />
                </Collapse.Panel>
                <Collapse.Panel header="Engine details" key="3">
                  <PropertiesFormList name="engine_details" />
                </Collapse.Panel>
